...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="text-center">
        ...
        <div class="mb-4">
            <p class="text-lg"><?php
             $query = "SELECT * FROM tbl_javascript where id = 5";
             ...
             $row = mysqli_num_rows($result);
              if ($row > 0) {
               ...
               <br></p>
            <input type="radio" name="option" value=" var colors = ['red', 'green', 'blue'];" id=" var colors = ['red', 'green', 'blue'];">
            <label for="var colors = ['red', 'green', 'blue'];" class="ml-2"><?php
             $query = "SELECT * FROM tbl_javascript where id = 5";
             $result = mysqli_query($con,$query);
             $row = mysqli_num_rows($result);
              if ($row > 0) {
    ...
    <script>
        function submitAnswer() {
            const correctAnswer = "var colors = ['red', 'green', 'blue'];";
